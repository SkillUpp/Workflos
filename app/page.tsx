      ...
      <div className="sm:px-[24px] sm:pt-[40px] pt-[80px] lg:px-[56px] xl:pl-[200px] relative flex justify-between pb-8 h-auto lg:pb-0 lg:h-[420px]">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col">
            <h3 className="text-[#9747ff] text-[36px] font-extrabold">Where business leaders find software</h3>
            ...
            <div className="pt-[40px]">
              <h3 className="text-black text-[24px] font-semibold leading-5">Explore software categories customers love</h3>
        ...
        <div className="hidden lg:block relative w-[35%] bottom-0 bg-search-bg bg-contain bg-no-repeat">
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-[#9747ff] rounded-[8px] w-[298px] flex flex-col items-center justify-center py-[8px]">
            <h3 className="text-white text-[60px]"> {totalCount ? totalCount / 1000 + 'K' : "0k"} </h3>
      ...
      <div className="relative z-10">
        <div className="w-full h-[52px] bg-black">
          <ul className="flex items-center justify-around h-full mx-[90px] list-none">
            {softworeTab.map((item) => (
              <li
                className={`flex items-center text-white text-[16px] cursor-pointer ${item.value === currentSort ? 'text-[#9747ff] border-b border-[#9747ff]' : ''}`}
                key={item.name}
        ...
        <div className="bg-[#f0f0f0] py-[50px] px-6 lg:px-[50px] 2xl:px-[200px]">
                ...
                {softworeList.map((item) => (
                  ...
                  >
                    <div className="flex-shrink-0 flex items-center">
                      <Image src={item.photo} alt="" width={40} height={40} className="rounded-md object-contain" />
                      <h3 className="pl-2 text-black text-2xl font-extrabold leading-tight whitespace-nowrap overflow-hidden text-ellipsis">{item.name}</h3>
                    </div>
                    <div className="pl-3 flex flex-col">

                      <p className="mt-1 text-sm text-black overflow-hidden text-ellipsis line-clamp-3" dangerouslySetInnerHTML={{
          ...
          {softworeList.length >= 10 && (
            <Link href={'/category'} className="w-[198px] h-[30px] mx-auto flex items-center justify-center bg-[#9747ff] rounded-[5px] text-white text-[16px] mt-[50px] cursor-pointer hover:opacity-80" onClick={() => handleJump("/category")}>

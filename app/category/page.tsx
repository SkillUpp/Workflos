...
const Category = () => {
	...
	return (
		<div className="pt-[86px] bg-[#f0f0f0] overflow-hidden min-h-[calc(100vh-86px)]">
			...
			<div>
				<h3 className="m-0 pt-[42px] px-[24px] lg:px-[56px] 2xl:px-[200px] pb-[14px] text-[32px] font-extrabold bg-white">Accounting Software</h3>
				<div className="flex items-center h-[52px] bg-black  px-[24px] lg:px-[56px] 2xl:px-[200px]">
					{categoryTabs.map((item) => (
						<div
							key={item.id}
							className={`text-[16px] text-white font-semibold ml-[160px] cursor-pointer first:ml-0 ${item.active ? 'text-[#9747ff] border-b border-[#9747ff] transition-all duration-300' : ''}`}
				...
				<div className="pt-[13px] pb-[64px] px-[24px] lg:px-[56px] 2xl:px-[200px] bg-[#f0f0f0]">
					<div className="flex items-center justify-between h-[42px]">
						<p className="text-[24px] font-extrabold text-black leading-[42px]">{totalCount} software options</p>
					</div>
					...
					<div className="flex items-center flex-col h-auto p-4 justify-between md:flex-row md:h-[57px] md:py-0 px-[20px] mt-[14px] bg-[#9747ff] rounded-[12px]">
						<div className="flex items-center">
							...
							<span className="pl-[16px] text-[20px] leading-8 text-white">Personalize your search</span>
						</div>
						...
						{softworeList.map((item: any) => (
							...
							>
								<div className="flex justify-between pb-[12px] mb-[12px] border-b border-[rgba(151,71,255,0.3)]">
									<div className="flex">
										<Image src={item.photo} alt="" width={77} height={77} className="w-[42px] h-[42px] md:w-[76px] md:h-[76px] rounded-[5px] object-contain" />
									...
									<div className="hidden md:flex">
										...
										>
											...
											<span className="pl-[10px] text-[#9747ff] text-[14px] leading-[1.2]">Compare</span>
										</button>
									</div>
